...
class Commit:
    ...
    def __str__(self):
        import json
        from . import Encoder
        return json.dumps(dict(self.__dict__), cls=Encoder, ensure_ascii=False)
...
class Component:
    ...
    def __init__(self, *, name: str, component_type: ComponentType = None,
                 ...
                 supplier: Optional[OrganizationalEntity] = None, author: Optional['Author'] = None,
                 ...
                 keywords: Optional[Iterable[str]] = None, project_url: Optional[str] = None,
        ...
        self.__dependencies: "SortedSet[Component]" = SortedSet()
        self.__vulnerabilities: "SortedSet[Vulnerability]" = SortedSet()
    ...
    @author.setter
    def author(self, author: Optional['Author']) -> None:
        self._author = author
    ...
    def project_url(self) -> Optional[str]:
        """
        Specifies the projects url of the component.
    ...
    @project_url.setter
    def project_url(self, project_url: Optional[str]) -> None:
    ...
    @property
    def keywords(self) -> Optional[Iterable]:
        """
        Specifies optional release notes.
    ...
    @keywords.setter
    def keywords(self, keywords: Optional[Iterable]) -> None:
        self._keywords = keywords

    @property
    def dependencies(self) -> "SortedSet[Component]":
        """
    ...
    @dependencies.setter
    def dependencies(self, dependencies: Iterable['Component']) -> None:
...
class Author:
    ...
    def __lt__(self, other: Any) -> bool:
        if isinstance(other, Property):
            return ComparableTuple((self.name, self.email)) < ComparableTuple((other.name, other.value))
        return NotImplemented
